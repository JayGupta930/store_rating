        ...
        <form onSubmit={handleSubmit} className="store-form">
          <div
            className={`form-field ${
              touched.storeName || formData.storeName ? "active" : ""
            }`}
          >
            ...
            <input
              ...
              required
            />
            <label htmlFor="storeName" className="floating-label">
              Store Name
            </label>
          </div>
          ...
          <div
            className={`form-field ${
              touched.email || formData.storeName ? "active" : ""
            }`}
          >
          ...
          <div
            className={`form-field ${
              touched.address || formData.address ? "active" : ""
            }`}
          >
          ...
          <div
            className={`form-field ${
              touched.category || formData.category ? "active" : ""
            }`}
          >
          ...
          <div
            className={`form-field ${
              touched.description || formData.description ? "active" : ""
            }`}
          >
